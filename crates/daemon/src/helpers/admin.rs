...
use gate_core::access::{Action, ObjectIdentity, Permissions, SubjectIdentity};
...
pub struct AdminPermissionHelper {
    pub permission_manager: Arc<crate::permissions::LocalPermissionManager>,
    pub state_backend: Arc<dyn StateBackend>,
    pub identity: HttpIdentity,
    pub local_identity: SubjectIdentity<LocalContext>,
}
